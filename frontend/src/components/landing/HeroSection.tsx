...
export function HeroSection() {
    return (
        <section className="relative overflow-hidden py-20 md:py-28 lg:py-36">
            ...
            {/* Top Layer: Raining Letters with transparency - above gradient */}
            <div className="absolute inset-0 z-[2] opacity-40 pointer-events-none">
                <RainingLetters />
            </div>

            {/* Smooth bottom fade for seamless transition */}
            <div className="absolute bottom-0 left-0 right-0 h-24 z-[3] bg-gradient-to-t from-background via-background/80 to-transparent" />
